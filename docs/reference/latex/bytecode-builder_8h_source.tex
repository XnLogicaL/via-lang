...
\DoxyCodeLine{00014\ \textcolor{preprocessor}{\#include\ <codegen/visitor.h>}}
\DoxyCodeLine{00015\ \textcolor{preprocessor}{\#include\ <\mbox{\hyperlink{types_8h}{codegen/types.h}}>}}
\DoxyCodeLine{00016\ \textcolor{preprocessor}{\#include\ <interpreter/instruction.h>}}
\DoxyCodeLine{00017\ \textcolor{preprocessor}{\#include\ <interpreter/state.h>}}
\DoxyCodeLine{00018\ }
...
\DoxyCodeLine{00160\ }
\DoxyCodeLine{00167\ \mbox{\hyperlink{namespacevia_a68cce66c29779f23c5ae3c4ed7f9be15}{operand\_t}}\ \mbox{\hyperlink{bytecode-builder_8cpp_a821ac9cae97689669d2c96e6d1411d28}{push\_constant}}(\mbox{\hyperlink{structvia_1_1VisitorContext}{VisitorContext}}\&\ ctx,\ \mbox{\hyperlink{structvia_1_1Value}{Value}}\&\&\ constant);}
\DoxyCodeLine{00168\ }
\DoxyCodeLine{00176\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{bytecode-builder_8cpp_ae336781c36f310148a11623a10fd6761}{resolve\_lvalue}}(\mbox{\hyperlink{structvia_1_1VisitorContext}{VisitorContext}}\&\ ctx,\ \mbox{\hyperlink{structvia_1_1ExprNodeBase}{ExprNodeBase}}*\ lvalue,\ \mbox{\hyperlink{namespacevia_a68cce66c29779f23c5ae3c4ed7f9be15}{operand\_t}}\ dst);}
\DoxyCodeLine{00177\ }
\DoxyCodeLine{00185\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{bytecode-builder_8cpp_aa83c6cf545d9a79002c7088f35f7ec31}{resolve\_rvalue}}(\mbox{\hyperlink{classvia_1_1NodeVisitorBase}{NodeVisitorBase}}*\ visitor,\ \mbox{\hyperlink{structvia_1_1ExprNodeBase}{ExprNodeBase}}*\ rvalue,\ \mbox{\hyperlink{namespacevia_a68cce66c29779f23c5ae3c4ed7f9be15}{operand\_t}}\ dst);}
\DoxyCodeLine{00186\ }
\DoxyCodeLine{00194\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{bytecode-builder_8cpp_a69030828d339302cc913315f7a911490}{bind\_lvalue}}(\mbox{\hyperlink{structvia_1_1VisitorContext}{VisitorContext}}\&\ ctx,\ \mbox{\hyperlink{structvia_1_1ExprNodeBase}{ExprNodeBase}}*\ lvalue,\ \mbox{\hyperlink{namespacevia_a68cce66c29779f23c5ae3c4ed7f9be15}{operand\_t}}\ src);}
\DoxyCodeLine{00195\ }
...
\DoxyCodeLine{00220\ \ \ Opcode\ opcode\ =\ Opcode::NOP,}
...
\DoxyCodeLine{00231\ }
\DoxyCodeLine{00237\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{namespacevia_a68cce66c29779f23c5ae3c4ed7f9be15}{operand\_t}}\ \mbox{\hyperlink{bytecode-builder_8h_a1a769bd32cb52620f99848cfe93fae0c}{alloc\_register}}(\mbox{\hyperlink{structvia_1_1VisitorContext}{VisitorContext}}\&\ ctx)\ \{}
\DoxyCodeLine{00238\ \ \ \textcolor{keywordflow}{return}\ ctx.reg\_alloc.\mbox{\hyperlink{classvia_1_1RegisterAllocator_a9520ef0cef2944106fd8de1920db18e8}{allocate\_register}}();}
\DoxyCodeLine{00239\ \}}
\DoxyCodeLine{00240\ }
\DoxyCodeLine{00247\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{bytecode-builder_8h_af77668addbda8eb247ec34282720901c}{free\_register}}(\mbox{\hyperlink{structvia_1_1VisitorContext}{VisitorContext}}\&\ ctx,\ \mbox{\hyperlink{namespacevia_a68cce66c29779f23c5ae3c4ed7f9be15}{operand\_t}}\ reg)\ \{}
\DoxyCodeLine{00248\ \ \ ctx.reg\_alloc.\mbox{\hyperlink{classvia_1_1RegisterAllocator_a803062b7bafc00fb5d1afe1160e4fb00}{free\_register}}(reg);}
\DoxyCodeLine{00249\ \}}
\DoxyCodeLine{00250\ }
...
\DoxyCodeLine{00269\ }
\DoxyCodeLine{00270\ \ \ \textcolor{keywordtype}{void}\ add\_unused\_expression\_handler(\textcolor{keyword}{const}\ unused\_expression\_handler\_t\&\ handler);}
\DoxyCodeLine{00271\ }
\DoxyCodeLine{00272\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00276\ \ \ \textcolor{keywordtype}{void}\ codegen\_prep();}
\DoxyCodeLine{00277\ }
\DoxyCodeLine{00281\ \ \ \textcolor{keywordtype}{void}\ insert\_exit0\_instruction();}
\DoxyCodeLine{00282\ }
\DoxyCodeLine{00283\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00284\ \ \ \mbox{\hyperlink{structvia_1_1VisitorContext}{VisitorContext}}\ ctx;}
\DoxyCodeLine{00285\ \};}
\DoxyCodeLine{00286\ }
\DoxyCodeLine{00287\ \}\ \textcolor{comment}{//\ namespace\ via}}
\DoxyCodeLine{00288\ }
