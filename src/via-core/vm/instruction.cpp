...
static OpInfo OPERAND_INFO_MAP[] = {
    ...
    {OpCode::BTOI, REGISTER, REGISTER},
    {OpCode::FTOI, REGISTER, REGISTER},
    {OpCode::STOI, REGISTER, REGISTER},
    {OpCode::ITOF, REGISTER, REGISTER},
    {OpCode::BTOF, REGISTER, REGISTER},
    {OpCode::STOF, REGISTER, REGISTER},
    {OpCode::ITOB, REGISTER, REGISTER},
    {OpCode::STOB, REGISTER, REGISTER},
    {OpCode::ITOS, REGISTER, REGISTER},
    {OpCode::FTOS, REGISTER, REGISTER},
    {OpCode::BTOS, REGISTER, REGISTER},
    {OpCode::ARTOS, REGISTER, REGISTER},
    {OpCode::DTTOS, REGISTER, REGISTER},
    {OpCode::FNTOS, REGISTER, REGISTER},
