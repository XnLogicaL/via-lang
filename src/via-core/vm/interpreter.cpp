...
via::ValueRef via::Interpreter::getLocal(usize mStkPtr)
{
  ...
  #define DISPATCH_TABLE()                                                    \
    DISPATCH_OP(NOP), DISPATCH_OP(HALT), DISPATCH_OP(EXTRAARG1),              \
      ...
      DISPATCH_OP(LOADK), DISPATCH_OP(LOADTRUE), DISPATCH_OP(LOADFALSE),      \
      DISPATCH_OP(NEWSTR), DISPATCH_OP(NEWARR), DISPATCH_OP(NEWDICT),         \
      DISPATCH_OP(NEWTUPLE), DISPATCH_OP(NEWCLOSURE), DISPATCH_OP(IADD1),     \
      DISPATCH_OP(IADD2), DISPATCH_OP(IADD1K), DISPATCH_OP(IADD2K),           \
      DISPATCH_OP(FADD1), DISPATCH_OP(FADD2), DISPATCH_OP(FADD1K),            \
      DISPATCH_OP(FADD2K), DISPATCH_OP(ISUB1), DISPATCH_OP(ISUB2),            \
      DISPATCH_OP(ISUB1K), DISPATCH_OP(ISUB2K), DISPATCH_OP(ISUB2KX),         \
      DISPATCH_OP(FSUB1), DISPATCH_OP(FSUB2), DISPATCH_OP(FSUB1K),            \
      DISPATCH_OP(FSUB2K), DISPATCH_OP(FSUB2KX), DISPATCH_OP(IMUL1),          \
      DISPATCH_OP(IMUL2), DISPATCH_OP(IMUL1K), DISPATCH_OP(IMUL2K),           \
      DISPATCH_OP(FMUL1), DISPATCH_OP(FMUL2), DISPATCH_OP(FMUL1K),            \
      DISPATCH_OP(FMUL2K), DISPATCH_OP(IDIV1), DISPATCH_OP(IDIV2),            \
      DISPATCH_OP(IDIV1K), DISPATCH_OP(IDIV2K), DISPATCH_OP(IDIV2KX),         \
      DISPATCH_OP(FDIV1), DISPATCH_OP(FDIV2), DISPATCH_OP(FDIV1K),            \
      DISPATCH_OP(FDIV2K), DISPATCH_OP(FDIV2KX), DISPATCH_OP(IPOW1),          \
      DISPATCH_OP(IPOW2), DISPATCH_OP(IPOW1K), DISPATCH_OP(IPOW2K),           \
      DISPATCH_OP(IPOW2KX), DISPATCH_OP(FPOW1), DISPATCH_OP(FPOW2),           \
      DISPATCH_OP(FPOW1K), DISPATCH_OP(FPOW2K), DISPATCH_OP(FPOW2KX),         \
      DISPATCH_OP(IMOD1), DISPATCH_OP(IMOD2), DISPATCH_OP(IMOD1K),            \
      DISPATCH_OP(IMOD2K), DISPATCH_OP(IMOD2KX), DISPATCH_OP(FMOD1),          \
      DISPATCH_OP(FMOD2), DISPATCH_OP(FMOD1K), DISPATCH_OP(FMOD2K),           \
      DISPATCH_OP(FMOD2KX), DISPATCH_OP(INEG), DISPATCH_OP(INEGK),            \
      DISPATCH_OP(FNEG), DISPATCH_OP(FNEGK), DISPATCH_OP(BAND1),              \
      DISPATCH_OP(BAND2), DISPATCH_OP(BAND1K), DISPATCH_OP(BAND2K),           \
      DISPATCH_OP(BOR1), DISPATCH_OP(BOR2), DISPATCH_OP(BOR1K),               \
      DISPATCH_OP(BOR2K), DISPATCH_OP(BXOR1), DISPATCH_OP(BXOR2),             \
      DISPATCH_OP(BXOR1K), DISPATCH_OP(BXOR2K), DISPATCH_OP(BSHL1),           \
      DISPATCH_OP(BSHL2), DISPATCH_OP(BSHL1K), DISPATCH_OP(BSHL2K),           \
      DISPATCH_OP(BSHR1), DISPATCH_OP(BSHR2), DISPATCH_OP(BSHR1K),            \
      DISPATCH_OP(BSHR2K), DISPATCH_OP(BNOT), DISPATCH_OP(BNOTK),             \
      DISPATCH_OP(AND), DISPATCH_OP(ANDK), DISPATCH_OP(OR), DISPATCH_OP(ORK), \
      DISPATCH_OP(IEQ), DISPATCH_OP(IEQK), DISPATCH_OP(FEQ),                  \
      DISPATCH_OP(FEQK), DISPATCH_OP(BEQ), DISPATCH_OP(BEQK),                 \
      DISPATCH_OP(SEQ), DISPATCH_OP(SEQK), DISPATCH_OP(INEQ),                 \
      DISPATCH_OP(INEQK), DISPATCH_OP(FNEQ), DISPATCH_OP(FNEQK),              \
      DISPATCH_OP(BNEQ), DISPATCH_OP(BNEQK), DISPATCH_OP(SNEQ),               \
      DISPATCH_OP(SNEQK), DISPATCH_OP(IS), DISPATCH_OP(ILT),                  \
      DISPATCH_OP(ILTK), DISPATCH_OP(FLT), DISPATCH_OP(FLTK),                 \
      DISPATCH_OP(IGT), DISPATCH_OP(IGTK), DISPATCH_OP(FGT),                  \
      DISPATCH_OP(FGTK), DISPATCH_OP(ILTEQ), DISPATCH_OP(ILTEQK),             \
      DISPATCH_OP(FLTEQ), DISPATCH_OP(FLTEQK), DISPATCH_OP(IGTEQ),            \
      DISPATCH_OP(IGTEQK), DISPATCH_OP(FGTEQ), DISPATCH_OP(FGTEQK),           \
      DISPATCH_OP(NOT), DISPATCH_OP(JMP), DISPATCH_OP(JMPIF),                 \
      DISPATCH_OP(JMPIFX), DISPATCH_OP(JMPBACK), DISPATCH_OP(JMPBACKIF),      \
      DISPATCH_OP(JMPBACKIFX), DISPATCH_OP(SAVESP), DISPATCH_OP(RESTSP),      \
      DISPATCH_OP(PUSH), DISPATCH_OP(PUSHK), DISPATCH_OP(GETARG),             \
      DISPATCH_OP(GETARGREF), DISPATCH_OP(SETARG), DISPATCH_OP(GETLOCAL),     \
      DISPATCH_OP(GETLOCALREF), DISPATCH_OP(SETLOCAL), DISPATCH_OP(CALL),     \
      DISPATCH_OP(PCALL), DISPATCH_OP(RET), DISPATCH_OP(RETNIL),              \
      DISPATCH_OP(RETTRUE), DISPATCH_OP(RETFALSE), DISPATCH_OP(RETK),         \
      ...
      DISPATCH_OP(DTTOS), DISPATCH_OP(FNTOS)
#else
...
#ifdef HAS_CGOTO
  [[gnu::aligned(64)]] static void* dispatch_table[] = {DISPATCH_TABLE()};
#endif
