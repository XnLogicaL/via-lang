...
static bool _has_printed_fname;
...
namespace via
{
    ...
    namespace Tokenization
    {
        ...
        namespace SourceLineHighlighter
        {
            ...
            // Helper function to split the source code into lines
            ...
            inline std::string get_severity_header(Severity sev)
            {
                switch (sev)
                {
                case Severity::INFO:
            ...
            inline std::string underline_line(
            ...
            inline void token_error(viaSourceContainer vsc, size_t idx, std::string message, Severity sev)
            {
                if (!_has_printed_fname)
                {
                    _has_printed_fname = true;
                    std::cout << std::format("In file {};", vsc.file_name) << '\n';
                }
