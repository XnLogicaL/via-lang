 ...
 */
void __native_call(IState* VIA_RESTRICT state, IFunction* VIA_RESTRICT _Callee, size_t _Argc);
 ...
 */
void __extern_call(IState* VIA_RESTRICT state, const IValue& _Callee, size_t _Argc);
