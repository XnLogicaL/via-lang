...
Closure::Closure(Function&& fn, size_t arity)
  : callee({Callable::Tag::Function, {.fn = fn}, arity}),
    upvs(new UpValue[10]),
    upv_count(0) {}

Closure::Closure(NativeFn fn, size_t arity)
  : callee({Callable::Tag::Function, {.ntv = fn}, arity}),
    upvs(new UpValue[10]),
    upv_count(0) {}
